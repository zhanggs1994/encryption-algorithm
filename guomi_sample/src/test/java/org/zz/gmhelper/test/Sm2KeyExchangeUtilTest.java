...
public class Sm2KeyExchangeUtilTest {
    ...
    public void TestCaculateKey() {
        try {
            AsymmetricCipherKeyPair initiatorStaticKp = Sm2Util.generateAsymmetricCipherKeyPair();
            ...
            AsymmetricCipherKeyPair initiatorEphemeralKp = Sm2Util.generateAsymmetricCipherKeyPair();
            ...
            AsymmetricCipherKeyPair responderStaticKp = Sm2Util.generateAsymmetricCipherKeyPair();
            ...
            AsymmetricCipherKeyPair responderEphemeralKp = Sm2Util.generateAsymmetricCipherKeyPair();
